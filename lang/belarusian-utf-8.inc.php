<?php
/* $Id: belarusian-utf-8.inc.php,v 1.1.2.2 2005/04/16 11:46:33 lem9 Exp $ */
...
$strAll = 'Усе';
$strAllTableSameWidth = 'паказваць усе табліцы з аднолькавай шырынёй?';
...
$strCheckOverhead = 'Праверыць выкарыстаньне рэсурсаў';
...
$strRefresh = 'Абнавіць';
$strRelationNotWorking = 'Дадатковыя магчымасьці работы з зьвязанымі табліцамі была адключаная. Каб высьветліць чаму, націсьніце %sтут%s.';
...
$strShowTableDimension = 'Паказваць разьмернасьць табліц';
...
$strTime = 'Час';
$strToggleScratchboard = 'Уключыць чарнавік';
$strTotal = 'усяго';
$strTotalUC = 'Агулам';
