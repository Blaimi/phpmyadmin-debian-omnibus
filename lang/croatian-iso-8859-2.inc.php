<?php
/* $Id: croatian-iso-8859-2.inc.php 9472 2006-09-29 21:12:52Z  $ */
...
$strAbsolutePathToDocSqlDir = 'Unesite apsolutnu putanju na web-poslu¾itelju do docSQL mape';
...
$strDBGHits = 'Pronala¾enja';
$strDBGLine = 'Redak';
$strDBGMaxTimeMs = 'Najdulje vrijeme (ms)';
$strDBGMinTimeMs = 'Najkraæe vrijeme (ms)';
$strDBGModule = 'Modul';
$strDBGTimePerHitMs = 'Vrijeme/Pronala¾enje (ms)';
...
$strTransformation_text_plain__dateformat = 'Prikazuje polja TIME, TIMESTAMP ili DATETIME (vrijeme, oznaka vremena, datum) sukladno lokalnom obliku datuma i vremena. Prva opcija je razlika (u satima) koja æe biti pridodana oznaci vremena (zadano: 0). Upotrijebite drugu opciju za odreðivanje razlièitog oblikovanja datuma i vremena. Detalje potra¾ite u PHP dokumentaciji, funkcija strftime().';
...
$strWritingCommentNotPossible = 'Zapisivanje komentara nije moguæe';
$strWritingRelationNotPossible = 'Zapisivanje relacija nije moguæe';
