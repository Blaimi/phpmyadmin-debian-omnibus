...
$strBookmarkQuery = 'ブックマークされているSQLクエりー';
$strBookmarkThis = 'SQLクエりーをブックマークする';
...
$strFieldsEnclosedBy = 'フィールドが囲んだ文字';
$strFieldsEscapedBy = 'フィールドのエスケープ文字';
$strFieldsTerminatedBy = 'フィールドの終了文字';
$strFixed = '固定';
...
$strHomepageSourceforge = 'SourceforgeでのphpMyAdminのダウのロードページ';
$strHost = 'ホスト';
...
$strInstructions = '教示';
$strInUse = '使用中';
$strInvalidName = '"%s"は登録された言葉ですから「データベース／テーブル／フィールド」名では使えません。';
...
$strNoFrames = '<b>フレーム</b>相性なブラウザーを使ったらphpMyAdminの方は使いやすいです。';
...
$strPrimary = '主要';
$strPrimaryKey = '主要キー';
$strPrimaryKeyHasBeenDropped = '主要キーキーを削除しました。';
...
$strRunning = 'が実行中です。 %s';
$strRunQuery = 'クエりーの実行';
$strRunSQLQuery = 'データベース%sにSQLクエりー実行';
...
$strShowPHPInfo = 'PHP情報の発表';
$strShowTables = 'テーブルの発表';
$strShowThisQuery = ' またこのクエりーをここに発表する ';
$strSingly = '(一回)';
$strSize = 'サイズ';
$strSort = 'ソート';
$strSpaceUsage = 'ディスク使用量';
$strSQLQuery = '実行されたSQLクエリー';
$strStartingRecord = '最初のれ高度';
...
$strTextAreaLength = ' 長さの所為でこのフィールドを<br /> 修正出来ない恐れがあります ';
...
$strUpdateQuery = 'クエりーのアップデート';
$strUsage = '使用量';
$strUseBackquotes = '逆クオートをテーブル名やフィールド名の周りに使う';
$strUser = 'ユーザー';
