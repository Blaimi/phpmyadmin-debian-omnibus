<?php
/* $Id: turkish-iso-8859-9.inc.php,v 2.150.2.1 2006/09/07 16:47:30 lem9 Exp $ */
...
$strDBGModule = 'Modül';
$strDBGTimePerHitMs = 'Süre/Ulaþma, ms';
...
$strIgnoringFile = '%s dosyasý yoksayýlýyor';
$strImportDocSQL = 'docSQL Dosyalarýný Ýçeri Aktar';
...
$strMIME_transformation_options_note = 'Lütfen dönüþüm seçenekleri için deðerleri bu biçimi kullanarak giriniz: \'a\',\'b\',\'c\'...<br />Eðer bu deðerler arasýna hep ters eðik çizgi ("\") veya tek týrnak ("\'") koymanýz gerekirse, önlerine ters eðik çizgi koyun (örneðin \'\\\\xyz\' veya \'a\\\'b\').';
